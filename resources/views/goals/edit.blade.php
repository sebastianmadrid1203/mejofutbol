...
<div class="container my-5">
    <div class="card shadow-lg border-0 animate__animated animate__fadeInDown mx-auto" style="max-width: 650px;">
        <div class="card-header bg-gradient-header text-white d-flex align-items-center">
            ...
            <span class="fs-5 fw-bold">Editar Gol #{{ $goal->id }}</span>
        </div>
        <div class="card-body">
            <form action="{{ route('goals.update', $goal->id) }}" method="POST" novalidate>
                @csrf
                @method('PUT')
                ...
                <div class="d-flex justify-content-between mt-4">
                    <button type="submit" class="btn btn-custom">
                        <i class="bi bi-check-circle me-1"></i> Actualizar Gol
                    </button>
